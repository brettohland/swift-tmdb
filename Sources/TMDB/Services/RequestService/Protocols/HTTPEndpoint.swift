...
//
// extension HTTPEndpoint where RequestBody == Void {
...
//
// extension HTTPEndpoint where RequestBody: Encodable {
...
//
// extension HTTPEndpoint where RequestBody == Void, ResponseBody == Void {
...
//
// extension HTTPEndpoint where RequestBody: Encodable, ResponseBody == Void {
...
//
// extension HTTPEndpoint where ResponseBody == Void {
...
//
// extension HTTPEndpoint where ResponseBody == Data {
//    func performRequest(_ request: URLRequest) async throws -> ResponseBody {
//        try await data(fromURLRequest: request)
//    }
// }
//
// extension HTTPEndpoint where RequestBody == Void, ResponseBody == Data {
...
//
// extension HTTPEndpoint where ResponseBody: Decodable {
//    func performRequest(_ request: URLRequest) async throws -> ResponseBody {
...
//
// extension HTTPEndpoint where RequestBody == Void, ResponseBody: Decodable {
//    func performRequest(queryItems: [URLQueryItem] = []) async throws -> ResponseBody {
//        let request = try makeURLRequest(queryItems: queryItems)
//        return try await performRequest(request)
//    }
...
//
// extension HTTPEndpoint where RequestBody: Encodable, ResponseBody: Decodable {
